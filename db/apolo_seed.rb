...
id_province_old << [3]
id_province_new << [new_reg.id]
new_reg=Province.create!(:detalle => "Mi Provincia", :company_id => id_company_new[ id_company_old.index(1)])
id_province_old << [4]
id_province_new << [new_reg.id]
=end
...
id_accounting_imputation_new << [new_reg.id]
new_reg=AccountingImputation.create!(:detalle => "Mi Cuenta Contable", :company_id => id_company_new[ id_company_old.index(1)])
...
id_data_to_ask_new << [new_reg.id]
new_reg=DataToAsk.create!(:detalle => "Mi Dato (no se a que se refiere)", :cantidad => true, :importe => true, :company_id => id_company_new[ id_company_old.index(1)])
...
id_category_new = []
new_reg=Category.create!(:detalle => "Administrativo", :importe => 6000.0, :company_id => id_company_new[ id_company_old.index(1)], :horas => 200.0, :codigo => "ADM")
id_category_old << [1]
id_category_new << [new_reg.id]
new_reg=Category.create!(:detalle => "Mi Categoria", :importe => 12000.0, :company_id => id_company_new[ id_company_old.index(1)], :horas => 200.0, :codigo => "c3")
id_category_old << [4]
id_category_new << [new_reg.id]
new_reg=Category.create!(:detalle => "Director", :importe => 12000.0, :company_id => id_company_new[ id_company_old.index(1)], :horas => 200.0, :codigo => "dr")
id_category_old << [2]
id_category_new << [new_reg.id]
new_reg=Category.create!(:detalle => "Enfermero", :importe => 3000.0, :company_id => id_company_new[ id_company_old.index(1)], :horas => 180.0, :codigo => "enf")
id_category_old << [3]
id_category_new << [new_reg.id]

id_retention_concept_old = []
id_retention_concept_new = []
new_reg=RetentionConcept.create!(:codigo => "002", :detalle => "Obra Social", :statistical_value => nil, :accounting_imputation_id => nil, :prioridad => nil, :formula_calculo_valor => "0.03 * @haberescondescuento", :acumuladores_valor => "@retenciones", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(1)], :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
id_retention_concept_old << [2]
id_retention_concept_new << [new_reg.id]
new_reg=RetentionConcept.create!(:codigo => "003", :detalle => "importe", :statistical_value => nil, :accounting_imputation_id => nil, :prioridad => nil, :formula_calculo_valor => "@haberescondescuento * 0.02", :acumuladores_valor => "@retenciones", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(3)], :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
id_retention_concept_old << [3]
id_retention_concept_new << [new_reg.id]
new_reg=RetentionConcept.create!(:codigo => "004", :detalle => "cantidad e importe", :statistical_value => nil, :accounting_imputation_id => nil, :prioridad => nil, :formula_calculo_valor => "importe *  cantidad", :acumuladores_valor => "@retenciones", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(4)], :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
id_retention_concept_old << [4]
id_retention_concept_new << [new_reg.id]
new_reg=RetentionConcept.create!(:codigo => "888", :detalle => "Adicional Obra Social", :statistical_value => 1, :accounting_imputation_id => id_accounting_imputation_new[ id_accounting_imputation_old.index(4)], :prioridad => 99, :formula_calculo_valor => "1", :acumuladores_valor => "1", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(1)], :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
...
id_remunerative_concept_new << [new_reg.id]
new_reg=RemunerativeConcept.create!(:codigo => "007", :detalle => "que es este codigo¿", :porcentual_asistencia => false, :prioridad_calculo => 1, :statistical_value => nil, :grupo_ganancias_id => nil, :accounting_imputation_id => nil, :concepto_asociado_haber_id => nil, :concepto_asociado_retencion_id => nil, :concepto_asociado_haber_2_id => nil, :concepto_asociado_retencion_2_id => nil, :acumuladores_valor => "@haberescondescuento", :acumuladores_cantidad => "", :calculo_valor => "novedad_haber:importe", :calculo_cantidad => "novedad_haber:cantidad", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(2)], :cantidad_en_recibo => "novedad_haber:cantidad", :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
...
id_remunerative_concept_new << [new_reg.id]
new_reg=RemunerativeConcept.create!(:codigo => "010", :detalle => "Plus Retiro de Residuos", :porcentual_asistencia => false, :prioridad_calculo => 1, :statistical_value => nil, :grupo_ganancias_id => nil, :accounting_imputation_id => nil, :concepto_asociado_haber_id => nil, :concepto_asociado_retencion_id => nil, :concepto_asociado_haber_2_id => nil, :concepto_asociado_retencion_2_id => nil, :acumuladores_valor => "@haberescondescuento", :acumuladores_cantidad => "", :calculo_valor => "novedad_haber:cantidad * 6.29", :calculo_cantidad => "novedad_haber:cantidad", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(2)], :cantidad_en_recibo => "novedad_haber:cantidad", :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
id_remunerative_concept_old << [23]
id_remunerative_concept_new << [new_reg.id]
new_reg=RemunerativeConcept.create!(:codigo => "011", :detalle => "Plus Mantenimiento Jardin", :porcentual_asistencia => false, :prioridad_calculo => 1, :statistical_value => nil, :grupo_ganancias_id => nil, :accounting_imputation_id => nil, :concepto_asociado_haber_id => nil, :concepto_asociado_retencion_id => nil, :concepto_asociado_haber_2_id => nil, :concepto_asociado_retencion_2_id => nil, :acumuladores_valor => "@haberescondescuento", :acumuladores_cantidad => "", :calculo_valor => "novedad_haber:cantidad * 85.95", :calculo_cantidad => "novedad_haber:cantidad", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(2)], :cantidad_en_recibo => "novedad_haber:cantidad", :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
...
id_remunerative_concept_new << [new_reg.id]
new_reg=RemunerativeConcept.create!(:codigo => "105", :detalle => "Dia del Encargado (2 de Oct)", :porcentual_asistencia => false, :prioridad_calculo => 20, :statistical_value => nil, :grupo_ganancias_id => nil, :accounting_imputation_id => nil, :concepto_asociado_haber_id => nil, :concepto_asociado_retencion_id => nil, :concepto_asociado_haber_2_id => nil, :concepto_asociado_retencion_2_id => nil, :acumuladores_valor => "@haberescondescuento", :acumuladores_cantidad => "", :calculo_valor => "(@haberesparaextras / 25) * novedad_haber:cantidad", :calculo_cantidad => "novedad_haber:cantidad", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(2)], :cantidad_en_recibo => "novedad_haber:cantidad", :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
id_remunerative_concept_old << [38]
id_remunerative_concept_new << [new_reg.id]
new_reg=RemunerativeConcept.create!(:codigo => "160", :detalle => "Horas Simples", :porcentual_asistencia => false, :prioridad_calculo => 20, :statistical_value => nil, :grupo_ganancias_id => nil, :accounting_imputation_id => nil, :concepto_asociado_haber_id => nil, :concepto_asociado_retencion_id => nil, :concepto_asociado_haber_2_id => nil, :concepto_asociado_retencion_2_id => nil, :acumuladores_valor => "@haberescondescuento", :acumuladores_cantidad => "", :calculo_valor => "(@haberesparaextras / 200)  * novedad_haber:cantidad", :calculo_cantidad => "novedad_haber:cantidad", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(2)], :cantidad_en_recibo => "novedad_haber:cantidad", :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
...
id_remunerative_concept_new << [new_reg.id]
new_reg=RemunerativeConcept.create!(:codigo => "151", :detalle => "Inasistencia p/Vacaciones", :porcentual_asistencia => false, :prioridad_calculo => 30, :statistical_value => nil, :grupo_ganancias_id => nil, :accounting_imputation_id => nil, :concepto_asociado_haber_id => nil, :concepto_asociado_retencion_id => nil, :concepto_asociado_haber_2_id => nil, :concepto_asociado_retencion_2_id => nil, :acumuladores_valor => "@haberescondescuento", :acumuladores_cantidad => "", :calculo_valor => "( @haberescondescuento / 30) * novedad_haber:cantidad", :calculo_cantidad => "novedad_haber:cantidad", :data_to_ask_id => id_data_to_ask_new[ id_data_to_ask_old.index(2)], :cantidad_en_recibo => "novedad_haber:cantidad", :company_id => id_company_new[ id_company_old.index(1)], :auxiliar => false)
