...
describe "employee_documents/new.html.haml" do
  before(:each) do
    assign(:employee_doc, stub_model(EmployeeDocument,
      :id_employee => 1,
      :name => "MyString",
  ...
  it "renders new employee_doc form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => employee_docs_path, :method => "post" do
