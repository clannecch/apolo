...
describe "sicoss_formats/new.html.haml" do
  before(:each) do
    assign(:sicoss_format, stub_model(SicossFormat,
      :position => 1,
      :name => "MyString",
      :field_length => 1,
  ...
  it "renders new sicoss_format form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => sicoss_formats_path, :method => "post" do
